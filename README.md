...
|Yejin Kim|AA|BB|CC|
|:---:|:---:|:---:|:---:|
|Admin Page, Payment System|Main page, My page|Live Streaming, Chat Service|Frontend, Login|
...
[**FRONT-END CODE REPO 🔗**](https://github.com/yejinaCodes/Live-CrowdFunding-Project)


[**BACK-END CODE REPO 🔗**](https://github.com/yejinaCodes/Live-CrowdFunding-Frontend)
